...
const STANDALONE_ROUTES = ["/login", "/onboarding", "/privacy-policy", "/terms-of-service"];
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "GitHub-integrated project management dashboard with AI-powered commit insights, real-time updates, and DORA metrics." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Syne:wght@500;600;700;800&family=DM+Sans:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" },
    ],
  }),
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {standalone ? <Outlet /> : <AppShell><Outlet /></AppShell>}
      <PWAInstallPrompt />
    </QueryClientProvider>
  );
}
